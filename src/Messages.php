...
class Messages
{
    ...
    public static function getValidatorPrompt(): array
    {
        return [
            ...
            'vi' => 'Thêm trình xác thực? [Y/n] (Enter = Y): ', 'tr' => 'Doğrulayıcı eklensin mi? [Y/n] (Enter = Y): ',
    ...
    public static function getMakeModelMessages(): array
    {
        ...
        $en = [
            ...
            'override_prompt' => "<question>File already exists: </question> <comment>{path}</comment>\n<question>Override? [Y/n] (Enter = Y)</question>\n",
            'enter_model_name_prompt' => "<question>Enter model name (Enter for {default}):</question>\n",
            'enter_model_path_prompt' => "<question>Enter model path (Enter for {default}):</question>\n",
